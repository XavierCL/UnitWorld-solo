...
// this class was highly inspired by the LUT solution demonstrated on this website:
// https://www.forceflow.be/2013/10/07/morton-encodingdecoding-through-bit-interleaving-implementations/

import utils.math.vector.Vector2Int;

public class MortonEncoder2D {

    public static long encode(Vector2Int vector2Int) {
        long result;
        result = mortonMaskDimension0[(vector2Int.x >> 24) & 0xFF] |
                mortonMaskDimension1[(vector2Int.y >> 24) & 0xFF];
        result = result << 16 |
                mortonMaskDimension0[(vector2Int.x >> 16) & 0xFF] |
                mortonMaskDimension1[(vector2Int.y >> 16) & 0xFF];
        result = result << 16 |
                mortonMaskDimension0[(vector2Int.x >> 8) & 0xFF] |
                mortonMaskDimension1[(vector2Int.y >> 8) & 0xFF];
        result = result << 16 |
                mortonMaskDimension0[vector2Int.x & 0xFF] |
                mortonMaskDimension1[vector2Int.y & 0xFF];

        return result;
    }

    private static final int[] mortonMaskDimension0 = new int[] {
            0, 1, 4, 5, 16, 17, 20, 21,
    ...
    private static final int[] mortonMaskDimension1 = new int[] {
